...
from .buffers import MuaxRolloutBuffer


class OnPolicyAlgorithmMuax(OnPolicyAlgorithm):
    policy: MCTSPolicy  # type: ignore[assignment]
    ...
    def _setup_model(self) -> None:
        ...
        self.rollout_buffer = MuaxRolloutBuffer(
            self.n_steps,
    ...
    def collect_rollouts(
        ...
        rollout_buffer: MuaxRolloutBuffer,
        n_rollout_steps: int,
    ) -> bool:
        """
        TODO: Modify
        ...
        while n_steps < n_rollout_steps:
            ...
            actions, log_probs, values = self.policy.predict_all(obs_tensor, self.policy.noise_key)  # 5. noise_key as arg
            ...
            if isinstance(self.action_space, gym.spaces.Box):
                # 6. if self.policy.squash_output else ...
            ...
            rollout_buffer.add(
                ...
                value=values,
                pi=pi,
                episode_start=self._last_episode_starts  # type: ignore
            )
        ...
        rollout_buffer.compute_Rn_and_weights(last_values=values, dones=dones)
